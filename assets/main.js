 ...
 */
!function(e){function t(e,t,n){var u=this;if(this._fncQueue=void 0===n?[]:n,this._delayCompleted=!1,this._$real=e,"number"==typeof t&&t>=0&&t<1/0)this.timeoutKey=window.setTimeout(function(){u._performDummyQueueActions()},t);else if(null!==t&&"object"==typeof t&&"function"==typeof t.promise)t.then(function(){u._performDummyQueueActions()});else{if("string"!=typeof t)return e;e.one(t,function(){u._performDummyQueueActions()})}}for(var n in t.prototype._addToQueue=function(e,t){return this._fncQueue.unshift({fnc:e,arg:t}),this._delayCompleted?this._performDummyQueueActions():this},t.prototype._performDummyQueueActions=function(){var e;for(this._delayCompleted=!0;this._fncQueue.length>0;){if("wait"===(e=this._fncQueue.pop()).fnc)return e.arg.push(this._fncQueue),this._$real=this._$real[e.fnc].apply(this._$real,e.arg);this._$real=this._$real[e.fnc].apply(this._$real,e.arg)}return this},e.fn.wait=function(e,n){return new t(this,e,n)},e.fn)"function"==typeof e.fn[n]&&e.fn.hasOwnProperty(n)&&(t.prototype[n]=function(e){return function(){var t=Array.prototype.slice.call(arguments);return this._addToQueue(e,t)}}(n))}(jQuery);
...
$(document).ready(function() {
	...
	Mousetrap.bind('up up down down left right left right b a enter', function() { darkSideOfTheMoon(); });
	...
	$('.burgerButton').click(function() {
		if(clickedBurger) {
			clickedBurger = false;
			$('.menuBar').removeClass('slideDown').addClass('slideUp').wait(300).toggleClass('active menuFocusOut');
			$('.menuFocus').removeClass('menuFocusIn').addClass('menuFocusOut').wait(300).removeClass('responsive slideUp');
		}
		else {
			clickedBurger = true;
