---
permalink: /assets/main.min.js
layout: compress
---
{% comment %} This entire file is a hack and will 100% break {% endcomment %}

{% comment %} Import tab escape sequence {% endcomment %}
{% include_relative tab.html %}

{% comment %} Import main.js file to minify {% endcomment %}
{% capture js %} {% include_relative /main.js %} {% endcapture %}
...
{% comment %} Remove all text after // and remove all // {% endcomment %}
{% for lineOfJS in jsFile %}
	{% if lineOfJS contains "//" %}

		{% assign withoutComment = lineOfJS | split: '//' %}
		
		{% assign final = final | append: withoutComment[0] %}

	{% else %}
		{% assign final = final | append: lineOfJS %}
	{% endif %}
{% endfor %}

{% comment %} Remove newlines and tab {% endcomment %}
{% assign final = final | strip_newlines | remove: tab %}
...
{% assign _comment_befores = final | split: "/*" %}
{% for _comment_before in _comment_befores %}
  ...
  {% if _comment_content %}
	...
	{% assign final = final | remove: _comment %}
  {% endif %}
{% endfor %}
