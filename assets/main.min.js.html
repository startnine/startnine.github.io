...
layout: compress
---
{% comment %} This entire file is a hack and will 100% break in the future
	to future self - if this breaks, you're going to have to rewrite it {% endcomment %}
...
{% comment %} The way this works is pretty dumb, urls have to be escaped {% endcomment %}
...
/* https://github.com/StartNine/start9.menu */
